...
PAYWALL_TEXT = (
    ...
    "📦 <b>Пакеты:</b>\n"
    "Мини: 5 фото — 139 ₽ → попробуй и оцени\n"
    "Базовый: 🔥 10 фото — 199 ₽ → лучший старт\n"
    "Стандартный: 50 фото — 499 ₽ → для экспериментов со стилями\n"
    "Премиум: 💎 100 фото — 899 ₽ → максимум свободы и творчества\n\n"
    "👇 Выбери Пакет и начни прямо сейчас!"
)
...
async def package_selected(callback: CallbackQuery) -> None:
    ...
    url = build_payment_url(
        ...
        description=f"Avocado AI Studio - {pkg['credits']} photos",
        receipt_name=f"Генерация AI-фото ({pkg['credits']} шт.)",
        user_id=uid,
    )
